; ModuleID = './cFiles/arithmetic.c'
source_filename = "./cFiles/arithmetic.c"
target datalayout = "e-S64-p:64:64-i64:64-m:e-n64"
target triple = "thru"

; Function Attrs: nounwind
define dso_local i32 @arithmetic(i32 noundef %x, i32 noundef %y, i32 noundef %z) #0 {
entry:
  ...
  store i32 %1, i32* %ans, align 4, !tbaa !3
  %2 = load i32, i32* %y.addr, align 4, !tbaa !3
  %3 = load i32, i32* %ans, align 4, !tbaa !3
  %add = add nsw i32 %3, %2
  store i32 %add, i32* %ans, align 4, !tbaa !3
  %4 = load i32, i32* %z.addr, align 4, !tbaa !3
  %5 = load i32, i32* %ans, align 4, !tbaa !3
  %sub = sub nsw i32 %5, %4
  store i32 %sub, i32* %ans, align 4, !tbaa !3
  %6 = load i32, i32* %x.addr, align 4, !tbaa !3
  %7 = load i32, i32* %ans, align 4, !tbaa !3
  %mul = mul nsw i32 %7, %6
  store i32 %mul, i32* %ans, align 4, !tbaa !3
  %8 = load i32, i32* %ans, align 4, !tbaa !3
  %9 = bitcast i32* %ans to i8*
